...
public class SparkRDD {
	...
	private static final String HADOOP_HOME_DIR_VALUE = "C:/hadoop_data";
	...
	// private static final String MONGODB_OUTPUT_URI =
	// "mongodb+srv://sanjiv1980:welcome2hmt@cluster0-mmifp.mongodb.net/meetupDB.collection-stream?retryWrites=true";

	private static final String MONGODB_OUTPUT_URI = "mongodb://127.0.0.1:27017/meetupDB.collection-stream?gssapiServiceName=mongodb";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		final SparkConf conf = new SparkConf().
				setMaster(RUN_LOCAL_WITH_AVAILABLE_CORES).setAppName(APPLICATION_NAME)
				.set("spark.mongodb.input.uri", MONGODB_OUTPUT_URI).
				 set("spark.mongodb.output.uri", MONGODB_OUTPUT_URI);

		JavaSparkContext sparkContext = new JavaSparkContext(conf);

		JavaRDD<ConsumerRecord<String, String>> rdd = KafkaUtils.createRDD(sparkContext, KAFKA_CONSUMER_PROPERTIES,
